...
const App: React.FC = () => {
  ...
  if (loading) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-slate-100 font-sans">
      <AnimatedLiquidBackground />
      <div className="relative z-10 text-center">
        <div className="w-12 h-12 border-2 border-blue-500 border-t-transparent rounded-full animate-spin mb-4 mx-auto"></div>
        <p className="text-blue-400 font-medium text-lg">Loading Idyll Productions...</p>
