...
const EditorDashboard: React.FC<EditorDashboardProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-black text-slate-100 font-sans pb-24 md:pb-0">
      {/* Sidebar */}
          ...
          <div className="flex items-center justify-between mb-8 card p-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-blue-500">Editor Dashboard</span>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:block px-3 py-1 bg-gray-800 rounded-full border border-gray-700">
                <span className="text-xs font-medium text-slate-500 uppercase">Editor</span>
              </div>
            </div>
          </div>
